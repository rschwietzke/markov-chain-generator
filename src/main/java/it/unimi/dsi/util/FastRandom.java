...
public class FastRandom
{
    ...
    /** 
     * Creates a new generator using the current time. That renders the purppose
     * of predictability a little void, but just to make subclassing for testing easier.
     */
   public FastRandom()
   {
    ...
    {
        var l = SplitMix64RandomGenerator.murmurHash3(seed);
    ...
    {
        var longArray = new long[additionalSeeds.length];
        for (int i = 0; i < additionalSeeds.length; i++)
        {
